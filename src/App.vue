...
<template>
  <aside
    id="logo-sidebar"
    class="overlay [--auto-close:sm] sm:shadow-none overlay-open:translate-x-0 drawer drawer-start hidden max-w-64 sm:absolute sm:z-0 sm:flex sm:translate-x-0 border-r-1 border-oklch-200"
    role="dialog"
    tabindex="-1"
  >
    <div class="drawer-header">
      <div class="flex items-center gap-3">
        ...
        <button
          type="button"
          class="btn btn-text btn-circle btn-sm absolute end-3 top-3 sm:hidden"
          aria-label="Close"
          data-overlay="#logo-sidebar"
        >
  ...
  <div class="fixed bottom-0 left-0 w-full border-t-1 border-oklch-200">
    <button
      type="button"
